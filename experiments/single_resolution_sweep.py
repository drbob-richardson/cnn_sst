...
def train_and_evaluate(data, labels, model, criterion, optimizer, device, num_epochs=10):
...
results_df.to_csv(str(_Path(__file__).resolve().parents[1] / "results" / "single_resolution_sweep_results.csv"), index=False)
