...
file_path = str(_Path(__file__).resolve().parents[1] / "data" / "sst_data.nc")
...
results_file = str(_Path(__file__).resolve().parents[1] / "results" / "window_lead_3dcnn_results.csv")
