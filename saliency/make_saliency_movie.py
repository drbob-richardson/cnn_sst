...
# Define the directories containing saliency images (single-res and deeper-CNN saliency).
_FIGURES = Path(__file__).resolve().parents[1] / "figures"
directories = [str(_FIGURES / "saliency_single_res"), str(_FIGURES / "saliency_deeper_cnn")]

# Output video file name
output_file = str(_FIGURES / "saliency_movie.mp4")
